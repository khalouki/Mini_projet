...
<?php
    ...
    $requ=("SELECT  *FROM client where genre='in' ");
    $res=mysqli_query($con,$requ);
?>
<!DOCTYPE html>
<html>
    <head>
        <title>les operation entrer</title>
    ...
    <table class="style">
       ...
       if(isset($_POST['find'])){
          ...
          $c=$_POST['cne'];
          $idd=$_SESSION['id'];
          $requ=("SELECT  *FROM client where nom='$n' AND prenom='$p' AND cne='$c' and genre='in' and id_users='$idd'");
          $res=mysqli_query($con,$requ);
        ...
        do{
          ...
          <tr>
             ...
             <td><?php echo $y?></td>
             <td><?php echo $c?></td>
             <td><button  class="mod"><a href="modifier2.php?id=<?= $id?>">modifer</a></button></td>
             <td><button class="sup" ><a href="suprimer2.php?id=<?= $id?>">suprimer</a></button></td>
        </tr>
    <?php
        ...
        $idd=$_SESSION['id'];
        $requ="SELECT *FROM client where genre='in'and id_users='$idd'";
        $res=mysqli_query($con,$requ);
        $et=mysqli_fetch_array($res);
          if(empty($et)){
             echo '<h1 class="message">il y aucun client  !!!</h1>';
            ...
            do{
                ...
                ?>
                    <tr>
                       ...
                       <td><?php echo $y?></td>
                       <td><?php echo $c?></td>
                       <td><button  class="mod" onclick=""><a href="modifier2.php?id=<?= $id?>">modifer</a></button></td>
                       <td><button class="sup" ><a href="suprimer2.php?id=<?= $id?>">suprimer</a></button></td>
                  </tr>
              <?php
              }while($et=mysqli_fetch_array($res));
